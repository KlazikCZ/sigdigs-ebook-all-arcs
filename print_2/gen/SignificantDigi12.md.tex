...
\chapter{Purchasing Power}\label{purchasing-power}}

\noindent {\capnums{}SIBERIAN SMASH: GODDESS STRIKES DOWN ``RUSSIAN
AZKABAN''}\\
\qsource{\emph{Daily Prophet}~headline for April 21st, 1999}\\

\noindent {\capnums{}WAR? ~THUNDERER THREATENS THRASHING}\\
\qsource{\emph{Daily Prophet}~headline for April 22nd, 1999}\\

\noindent {\capnums{}MUGGLE MAGIC AS TOWER LAUNCHES SPACE}\\
\qsource{\emph{Daily Prophet}~headline for April 23rd, 1999}\\

\noindent {\capnums{}GODDESS GOES WINDOW SHOPPING AT B\&B}\\
\qsource{\emph{Daily Prophet}~headline for April 24th, 1999}\\

\noindent {\capnums{}``MONSTROUS'': NEW PICTURES FROM ZEMLYA}\\
\qsource{\emph{Daily Prophet}~headline for April 25th, 1999}\\

\noindent {\capnums{}CONFLICT BREWING: THUNDERER CALLS CONCLAVE OF
DOMOVOI}\\
\qsource{\emph{Daily Prophet}~headline for April 26th, 1999}\\

\noindent {\capnums{}INDEPENDENTS UNITE BEHIND RUSSIA}\\
\qsource{\emph{Daily Prophet}~headline for April 27th, 1999}\\

\mybreak
\pagebreak

\emph{Department of Magical Law Enforcement, Ministry of Magic}\\
\emph{April 28th, 1999}\\

``No,'' said Hortense Hood, frowning. ``You really can't be in there.
Sorry.'' She didn't sound sorry. She sounded like a long-serving auror
whose career had been in a nasty slump for years, and who blamed the
Goddess for that, and who was enjoying the opportunity to get some
revenge -- even if it was in the most petty way imaginable.

Hermione didn't allow herself to sigh, and kept a pleasant smile on her
...
Hermione knew other immature-seeming aurors (like that one with great
...
Hermione shook her head, ruefully. She'd need to try harder to reach
...
``Yes, there's a canteen for Ministry staff. But let's go to
...
\emph{Not that they care}, she thought, clasping a young man's hand.
...
``Hello, Reg. And Master Aavik! A pleasure to see you again. I hope
...
``And end up somewhere with a decent bite?'' said Hig, smiling a
...
``This is what I say,'' said Per, nodding approvingly. ``Yes,
...
``Isn't it a bother to go to a Muggle place, though? Not this one, it's
...
Per seemed uncertain at the sudden change in tone of the conversation,
...
``Fifty percent, and you can work out the terms of a price index with
the Tower.''
...
Even if it was a trap, it had to be admitted that the auror posed only a
...
``Hortense, knock it off,'' said the other auror. ``Mukwooru's toe, this
...
Hood frowned. The muscular auror rose from her chair, though, and jerked
